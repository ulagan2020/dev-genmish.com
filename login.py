...
class dashBoard:
    def __init__(self,root,usr):
        ...
        title=Label(self.root,text="-----SHOP FOR LIQUORS----- ",font=("times new roman",14,"bold"),bg="#f3fbfe",fg='crimson')
        title.pack(side=TOP,fill=X)


        M_F= Frame(self.root,bd=2,relief=RIDGE,bg="#f3fbfe")
        M_F.place(x=100,y=100,width=1200,height=580)
    ...
    def userManagment(self):
        ...
        SrchBtn=Button(M_F,text="DASHBOARD",command=self.fetch_STdata,width=30,bg="#2f8fdd",fg="white").grid(row=3,column=0,padx=20,pady=20)

             
        SrchEBtn=Button(M_F,text="INVENTORY MANAGEMENT",command=self.fetch_Edata,width=30,bg="#2f8fdd",fg="white").grid(row=5,column=0,padx=20,pady=20)

       
        SrchSBtn=Button(M_F,text="RANK MANAGEMENT",command=self.fetch_Sdata,width=30,bg="#2f8fdd",fg="white").grid(row=7,column=0,padx=20,pady=20)

       
        Log_Btn=Button(M_F,text="QUOTA MANAGEMENT",command=self.fetch_Sdata,width=30,bg="#2f8fdd",fg="white").grid(row=9,column=0,padx=20,pady=20)

        SrchEBtn=Button(M_F,text="USER MANAGEMENT",command=self.fetch_Edata,width=30,bg="#2f8fdd",fg="white").grid(row=11,column=0,padx=20,pady=20)
    ...
    def fetch_STdata(self):
        
        pass
        '''
        #print("Student details")
        #usr=fetch_Studentdata(r)
        D_F= Frame(self.root,bd=4,relief=RAISED,bg="#f3fbfe")
        D_F.place(x=300,y=100,width=800,height=600)
          
        M_title=Label(D_F,text="STUDENT DETAILS",font=("times new roman",20,"bold"),bg="#2f8fdd",fg='white')
        ...
        e1_Lbl.grid(row=2,column=2)

        e1 = Entry(D_F, width=40,borderwidth=5)
        e1.grid(row=2, column=3,padx= 15, pady= 15)
        e1.insert(1, self.usr[2])

        e2_Lbl=Label(D_F,text="Last Name:",font=("times new roman",13,"bold"),bg="#2f8fdd",fg='white')
        e2_Lbl.grid(row=4,column=2)

        
        e2 = Entry(D_F, width=40,borderwidth=5)
        e2.grid(row=4, column=3,padx= 10, pady= 10)
        e2.insert(0, self.usr[3])
 
        e3_Lbl=Label(D_F,text="Email:",font=("times new roman",13,"bold"),bg="#2f8fdd",fg='white')
        e3_Lbl.grid(row=6,column=2)


        e3 = Entry(D_F, width=40,borderwidth=5)
        e3.grid(row=6, column=3,padx= 10, pady= 10)
        e3.insert(0, self.usr[4])

        e4_Lbl=Label(D_F,text="Phone:",font=("times new roman",13,"bold"),bg="#2f8fdd",fg='white')
        e4_Lbl.grid(row=8,column=2)


        e4 = Entry(D_F, width=40,borderwidth=5)
        e4.grid(row=8, column=3,padx= 10, pady= 10)
        e4.insert(0, self.usr[5])

        e5_Lbl=Label(D_F,text="State:",font=("times new roman",13,"bold"),bg="#2f8fdd",fg='white')
        e5_Lbl.grid(row=10,column=2)

        
        e5 = Entry(D_F, width=40,borderwidth=5)
        e5.grid(row=10, column=3,padx= 10, pady= 10)
        e5.insert(0, self.usr[6])

        e6_Lbl=Label(D_F,text="City:",font=("times new roman",13,"bold"),bg="#2f8fdd",fg='white')
        e6_Lbl.grid(row=12,column=2)

        e6 = Entry(D_F, width=40,borderwidth=5)
        e6.grid(row=12, column=3,padx= 10, pady= 10)
        e6.insert(0, self.usr[7])

        e7_Lbl=Label(D_F,text="Country:",font=("times new roman",13,"bold"),bg="#2f8fdd",fg='white')
        e7_Lbl.grid(row=14,column=2)

        e7 = Entry(D_F, width=40,borderwidth=5)
        e7.grid(row=14, column=3,padx= 10, pady= 10)
        e7.insert(0, self.usr[8])

        
        #print(ST_DETAILS)

        SubmitBtn=Button(D_F,text="EDIT & UPDATE",
                         command=lambda: self.submit_Data(e1.get(),e2.get(),e3.get(),e4.get(),e5.get(),e6.get(),e7.get())
